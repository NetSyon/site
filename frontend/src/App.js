        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Tailored technology services for every need - from personal computing to enterprise infrastructure
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="group bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 border border-blue-100">
              ...
              <h3 className="text-2xl font-bold text-slate-800 mb-4">Home Users & Cybersecurity</h3>
              <p className="text-slate-600 mb-6">Comprehensive home IT security and optimization services for modern families</p>
            ...
            <div className="group bg-gradient-to-br from-green-50 to-emerald-50 p-8 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 border border-green-100">
              ...
              <h3 className="text-2xl font-bold text-slate-800 mb-4">Small & Medium Business</h3>
              <p className="text-slate-600 mb-6">Scalable IT solutions and security services designed to protect and grow your business</p>
              <ul className="text-slate-600 space-y-2 mb-8">
                <li className="flex items-center">
            ...
            <div className="group bg-gradient-to-br from-purple-50 to-indigo-50 p-8 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 border border-purple-100">
              ...
              <p className="text-slate-600 mb-6">Advanced security implementations and compliance solutions for large organizations</p>
              <ul className="text-slate-600 space-y-2 mb-8">
                <li className="flex items-center">
